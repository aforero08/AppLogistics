...
namespace AppLogistics.Services.Tests
{
    public class RoleServiceTests
    {
        ...
        public void GetView_SetsSelectedIds()
        {
            ...
            IEnumerable<int> expected = role.Permissions.Select(rolePermission => rolePermission.PermissionId).OrderBy(id => id);
            IEnumerable<int> actual = service.GetView(role.Id).Permissions.SelectedIds.OrderBy(id => id);
        ...
        public void Create_RolePermissions()
        {
            ...
            IEnumerable<int> expected = view.Permissions.SelectedIds.OrderBy(permissionId => permissionId);
        ...
        public void Edit_RolePermissions()
        {
            ...
            IEnumerable<int> actual = context.Set<RolePermission>().AsNoTracking().Select(rolePermission => rolePermission.PermissionId).OrderBy(permissionId => permissionId);
            IEnumerable<int> expected = view.Permissions.SelectedIds.OrderBy(permissionId => permissionId);
        ...
        private MvcTree CreatePermissions()
        {
            ...
            expectedTree.SelectedIds = new HashSet<int>(role.Permissions.Select(rolePermission => rolePermission.PermissionId));
